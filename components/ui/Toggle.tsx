  ...
  return (
    <div className="sm:hidden flex w-full items-center justify-center sm:mt-0 mt-5 mb-1">
      <Switch.Group as="div" className="flex items-center">
        ...
        >
          <span
            className={`font-medium ${chatOnlyView ? 'text-gray-400' : 'text-gray-900 font-semibold'
              }`}
          >
            PDF + Chat
          </span>
        ...
        <Switch
          ...
          className={classNames(
            ...
            'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black',
          )}
        >
          <span
            aria-hidden="true"
