        ...
        {data.map(({ title, description, image }, index) => (
          <div key={index}>
            ...
            <div className="flex flex-col items-center gap-2 sm:gap-9">
              ...
              <Link
                href="/dashboard"
                className="flex gap-3 sm:gap-[33px] px-6 sm:px-[37px] py-[1px] sm:py-[14px] items-center border rounded-[29px] border-solid border-primary transition-all duration-300 hover:bg-primary hover:text-white"
              >
